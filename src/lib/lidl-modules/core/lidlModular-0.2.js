/**
 *
 * modular and revised version of the framework, for usage with a bundler such as webpack
 *
...
lidl.Lidl.prototype.addPlugin = function(lidlPlugin){
    this.plugins.push(lidlPlugin);
}

lidl.lidlPlugin = function(name){
    this.name = name;
}
 ...
 */
lidl.Lidl.prototype.addManager =  function (managerObject,isUnique){
 ...
 */
lidl.Lidl.prototype.getDebugCategories = function(){
    return this.debugCategoriesPresent;
};
 ...
 * @returns {debugCategory[]}
 */
lidl.Lidl.prototype.setDebugCategories = function(categories){
    return this.debugCategoriesPresent;
};
...
lidl.Lidl.prototype.addDebugCategory = function(category){
    let self = this;
    self.debugCategoriesPresent.forEach(function(el){
        if(el==category){
            return self.debugCategoriesPresent;
        }
    });
    self.debugCategoriesPresent.push(category);
    return self.debugCategoriesPresent;
};
...
lidl.Lidl.prototype.removeDebugCategory = function(category){
    let self = this;
    self.debugCategoriesPresent.forEach(function(el){
        if(el==category){
            self.debugCategoriesPresent.splice(i,1);
        }
    });
    return this.debugCategoriesPresent;
};

lidl.Lidl.prototype.debugSelect = function(debugCategory){
    var a = this.debugCategoriesPresent.indexOf(debugCategory);
    return (a!==-1);
}
