...
// import "./lidl-dialog.css"
import "./lidl-dialog-slider.css"
...
var Dialog = function (token, targetElementSelector, type, content, args, callback) {
...
Dialog.prototype.confirmAndClose = function(){
    confirmAndClose(this);
};

Dialog.prototype.setCallback = function(cb){
    this.callback = verifyCallback(cb);
}

Dialog.prototype.enableConfirm = function(){
    this.confirmBtn.removeClass("btn-disabled");
    this.allowConfirm = true;
}

Dialog.prototype.disableConfirm = function(){
